...
public class ClosestPair {
    ...
    // find the closest pair of points in pointsSortedByX[lo..hi]
    ...
    public static void main(String[] args) {
        ...
        String s = "/Users/hanzili/Desktop/A3/src/kw1260.txt";
        ...
        Point2D b = new Point2D(1,4);
        Point2D c = new Point2D(2,3);
        Point2D d = new Point2D(2,1);
        Point2D e = new Point2D(3,1);
        Point2D f = new Point2D(4,3);

        Point2D[] listA = {a,b,c,d,e,f};
        Point2D[] aux = new Point2D[6];
        merge(listA,aux,0,2,5);
...
/*if (lowA > highA && lowB > highB) {return Double.POSITIVE_INFINITY;}
        if (lowA > highA && lowB == highB) {return Double.POSITIVE_INFINITY;}
        if (lowB > highB && lowA == highA) {return Double.POSITIVE_INFINITY;}
        if (lowA == highA && lowB == highB) {return aPointsSortedByX[lowA].distanceTo(bPointsSortedByX[lowB]);}
